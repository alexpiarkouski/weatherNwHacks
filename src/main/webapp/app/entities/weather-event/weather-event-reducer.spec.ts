...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEATHEREVENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEATHEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEATHEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEATHEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEATHEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEATHEREVENT actions', async () => {
      const expectedActions = [
        {
