...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './event-area-segment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTAREASEGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVENTAREASEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTAREASEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTAREASEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTAREASEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTAREASEGMENT actions', async () => {
      const expectedActions = [
        {
